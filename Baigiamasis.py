...
# df_gintarine_data = pd.DataFrame(gintarine_data) #DataFrame sukuria grazu lenteles vaizda
# df_gintarine_data.to_csv('gintarine.csv', index=False)
# print(df_gintarine_data)
...
# # print(metu_data)
#
# df_metu_data = pd.DataFrame(metu_data)
# df_metu_data.to_csv('100metu.csv', index=False)
# print(df_metu_data)